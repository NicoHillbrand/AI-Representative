...
| Action | How |
|---|---|
| Show / hide | `Ctrl/Cmd+Shift+Space` (rebindable in settings), tray click, `Esc` hides to tray, `–` minimizes to the taskbar, `✕` quits the app. The overlay stays on screen until you explicitly hide it, and the window auto-sizes to your friends list. |
